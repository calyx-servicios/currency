===================================
Manual Currency Exchange Rate Block
===================================
...
.. |badge2| image:: https://img.shields.io/badge/licence-AGPL--3-blue.png
    ...
    :alt: License: AGPL-3
.. |badge3| image:: https://img.shields.io/badge/github-calyx--servicios%2Fcurrency-lightgray.png?logo=github
    :target: https://github.com/calyx-servicios/currency.git
    :alt: calyx-servicios/currency.git

|badge1| |badge2| |badge3|

.. !!! Description must be max 2-3 paragraphs, and is required.

This module extends the functionality of Manual Currency Exchange Rate to block the currency exchange selector on
invoice form when the selected currency is the same as the current company.
